...
exact files or discovery target, deterministic validation, and authority.
Report model/session identity only from authoritative runtime metadata; say
unknown otherwise. Quote only exact observed source text and label other
restatements as paraphrase or inference. Hand off to Guardian if repository
