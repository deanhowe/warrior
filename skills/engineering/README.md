...
Skills for code work across all harnesses (Kiro, Claude Code, Copilot, Codex).

## User-invoked

Reachable only when you type them (Claude Code: `disable-model-invocation: true`; Codex: `policy.allow_implicit_invocation: false` in `agents/openai.yaml`; Kiro: skill progressive-loading, invoked by name).

- **[ask-warrior](./ask-warrior/SKILL.md)** — Ask which skill or flow fits your situation. A router over the user-invoked skills in this repo.
